...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: "《Vue设计与实现》", link: "/note/vue-design/" },
    ...
    repo: "baiye0/baiye-blog", // 导航栏右侧生成Github链接
    ...
    author: {
      name: "baiye", // 必需
      link: "https://github.com/baiye0", // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: "/baiye-blog/img/head.png",
      name: "Baiye",
      slogan: "前端小白",
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: "icon-erji",
          title: "听音乐",
          link: "https://music.163.com/#/user?id=291117873",
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'baiye | <a href="https://github.com/baiye0/baiye-blog" target="_blank">博客项目</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
  ...
  plugins: <UserPlugins>[
    ...
    //       owner: "baiye0", // GitHub仓库所有者
    //       admin: ["baiye0"], // 对仓库有写权限的人
